...
namespace ecommerce_finalproject.Data.Cart
{
    public class ShoppingCart
    {
        ...
        {
            var shoppingCartItem = _context.ShoppingCartItems.FirstOrDefault(n => n.Products.Id == products.Id &&
